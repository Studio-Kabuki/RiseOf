  ...
  return (
    <div
      ...
      style={{
        ...
        borderTop: disabled ? '2px solid #808080' : '2px solid #DFDFDF',
        borderLeft: disabled ? '2px solid #808080' : '2px solid #DFDFDF',
        borderBottom: disabled ? '2px solid #404040' : '2px solid #808080',
        borderRight: disabled ? '2px solid #404040' : '2px solid #808080',
        padding: 6,
